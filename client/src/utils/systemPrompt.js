...
[GOLD_CHANGE: old=N, new=N, reason="..."]
[SANITY_CHANGE: old=N, new=N, reason="..."]
[XP_GAIN: amount=N, source="...", reason="..."]
[ITEM_ACQUIRED: name="...", rarity="common|uncommon|rare|epic|legendary", type="...", desc="..."]
[ITEM_REMOVED: name="...", reason="..."]
[QUEST_UPDATE: id="...", status="active|completed|failed", progress=N, objective="...", giver="...", consequence="..."]
[NPC_UPDATE: name="...", relationship="ally|friendly|neutral|hostile|rumored", status="...", location="..."]
[COMBAT_START: enemies="Wolf:8/8, Bandit:12/12", environment="..."]
[ENEMY_HP: name="Wolf", hp=N]
[COMBAT_LOG: text="The wolf lunges and misses.", kind="action|hit|miss|system"]
[COMBAT_END: result="...", xp=N]
[ROLL_RESULT: type="...", rolled=N, modifier=N, dc=N, result="success|failure|critical_success|fumble"]
